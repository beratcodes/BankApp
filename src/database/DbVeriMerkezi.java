...
public class DbVeriMerkezi extends DbConnection {
    ...
    protected double elektirikFaturasi,suFaturasi,dogalgazFaturasi,internetFaturasi; 
    ...
    public double getElektirikFaturasi() {
        return elektirikFaturasi;
    }

    public void setElektirikFaturasi(double elektirikFaturasi) {
        this.elektirikFaturasi = elektirikFaturasi;
    }
